...
obj.mapping = {
  ...
  resizeOut = { obj.mash, '=' },
  resizeIn = { obj.mash, '-' },
  arrangeWindows = { obj.mash, 'a' },
  arrangeThreeColumns = { obj.mash, 't' },
}
...
function obj:arrangeThreeColumns()
  ...
  local positions = {
    { x = 0.00, y = 0.00, w = 1.00, h = 0.33 },         -- top third
    { x = 0.00, y = 0.33, w = 1.00, h = 0.34 },         -- middle third (slightly taller for rounding)
    { x = 0.00, y = 0.67, w = 1.00, h = 0.33 }          -- bottom third
  }
  
  -- Get only the first 3 apps (most recent ones)
  for i = 1, math.min(3, #apps) do
...
function obj:bindHotkeys(mapping)
  ...
  self.hs.hotkey.bind(self.mapping.arrangeWindows[1], self.mapping.arrangeWindows[2], function() 
    self:arrangeWindows() 
  end)
  self.hs.hotkey.bind(self.mapping.arrangeThreeColumns[1], self.mapping.arrangeThreeColumns[2], function() 
    self:arrangeThreeColumns() 
  end)
